...
```bash
go test -v --bench github.com/Evrynetlabs/evrsdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/Evrynetlabs/evrsdk/crypto/keys/mintkey
...
PASS
ok  	github.com/Evrynetlabs/evrsdk/crypto/keys/mintkey	12.093s
```
