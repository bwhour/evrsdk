...
[![API Reference](https://godoc.org/github.com/Evrynetlabs/evrsdk/crypto/keys?status.svg)](https://godoc.org/github.com/Evrynetlabs/evrsdk/crypto/keys)


## The Keybase interface

The [Keybase](https://godoc.org/github.com/Evrynetlabs/evrsdk/crypto/keys#Keybase) interface defines
...
The [New](https://godoc.org/github.com/Evrynetlabs/evrsdk/crypto/keys#New) constructor returns
...
Due to [security concerns](https://github.com/Evrynetlabs/evrsdk/blob/master/docs/architecture/adr-006-secret-store-replacement.md), we recommend to drop
...
The [NewInMemory](https://godoc.org/github.com/Evrynetlabs/evrsdk/crypto/keys#NewInMemory) constructor returns
...
The [NewKeyring](https://godoc.org/github.com/Evrynetlabs/evrsdk/crypto/keys#NewKeyring) constructor returns
...
Both [NewKeyringFile](https://godoc.org/github.com/Evrynetlabs/evrsdk/crypto/keys#NewKeyringFile) and
[NewTestKeyring](https://godoc.org/github.com/Evrynetlabs/evrsdk/crypto/keys#NewTestKeyring) constructors return
