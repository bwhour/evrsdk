...
import (
	...
	storetypes "github.com/Evrynetlabs/evrsdk/store/types"
...
func (app *BaseApp) cacheTxContext(ctx sdk.Context, txBytes []byte) (sdk.Context, sdk.CacheMultiStore) {
	ms := ctx.MultiStore()
	// TODO: https://github.com/Evrynetlabs/evrsdk/issues/2824
...
func (app *BaseApp) runTx(mode runTxMode, txBytes []byte, tx sdk.Tx) (gInfo sdk.GasInfo, result *sdk.Result, err error) {
	...
	if app.anteHandler != nil {
		...
		// Ref: https://github.com/Evrynetlabs/evrsdk/issues/2772
		//
